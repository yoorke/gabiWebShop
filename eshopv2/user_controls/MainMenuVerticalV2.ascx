            ...
            <ItemTemplate>
                <li id="li" runat="server">
                    ...
                    <asp:Hyperlink ID="lnkMenuItem" runat="server" NavigateUrl='<%#Eval("url") %>'>
                        <asp:Image ID="imgCategory" runat="server" ImageUrl='<%#Eval("imageUrl") %>' CssClass="category-icon" Visible='<%#!Eval("imageUrl").ToString().Equals(string.Empty) %>' />
                        <asp:Label ID="lblName" runat="server" Text='<%#Eval("name") %>' CssClass="category-name"></asp:Label>
                    </asp:Hyperlink>
