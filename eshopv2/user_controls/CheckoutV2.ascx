        ...
        <div class="col-lg-10 col-lg-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <asp:LinkButton ID="btnBack" runat="server" Text="Vrati se na korpu" CssClass="btn btn-primary" OnClick="btnBack_Click" CausesValidation="false"></asp:LinkButton>
                            <asp:LinkButton ID="btnOrder" runat="server" Text="Naruči" CssClass="btn btn-primary pull-right" OnClick="btnOrder_Click"></asp:LinkButton>
                        </div><!--col-->
                    </div><!--row-->
                </div><!--panel-body-->
            </div><!--panel-->
